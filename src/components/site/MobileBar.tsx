  ...
  return (
    <div className="lg:hidden fixed bottom-0 inset-x-0 z-40 border-t border-cream/15 bg-ink/95 backdrop-blur-md">
      <div className="grid grid-cols-3 divide-x divide-cream/10">
        <a href="tel:0119561186" className="flex flex-col items-center gap-1 py-3 text-[10px] tracking-[0.2em] uppercase font-medium text-cream/85">
        ...
        <a
          href="https://www.google.com/maps/place/Trattoria+A+Casa+Mia/@45.0702341,7.5215887,17z"
          target="_blank"
